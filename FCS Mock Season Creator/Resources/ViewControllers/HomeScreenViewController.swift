...
class HomeScreenTableViewController: UITableViewController {
    ...
    @objc func infoButtonTapped() {
        ...
        let message = "Welcome! This app allows you to make predictions about all FCS football games in the current season or just in one conference and then see the most likely results for your predictions. You can not only make predictions about who will win each game, but your confident in that result! If you are very certain (~95%) one team will win some game, but only 55% confident they will win another game, the first game will count more towards the likelihood of a win than the second. The app will get better at predicting the end of season results as the season goes on, with the winners of each game being updated automatically and confidences for each game already played set to 100%. As a result, take note of your predictions before the season starts, and see how accurate you were as the season goes on!\n\nThe FCS Mock Season Creator uses the statistical Binomial Theorem on the backend to predict the likelihood of a team going a certain record given the number of games they play (n) and the number of wins (k). The application calculates the probability of each possible record and then presents the most likely one in the Results. The Stats page shows the likelihood of each individual record for each team.\n\nIf you have any comments, questions about how the app works, or suggestions please leave a review on the App Store or email the developer directly at fcsmockseasoncreator@gmail.com, and thanks!"
